...
export default function Login() {
  return (
    <section className="bg-[#161D31] w-screen h-screen flex items-center justify-center overflow-hidden">
      ...
      before:z-[-1] before:bg-no-repeat before:right-[-30%] before:bottom-[-10%] before:contents-[''] before:w-[250px] before:h-[240px] before:absolute before:bg-[url('data:image/png;base64,')]
      ">
        ...
        <h1 className="text-[15px] mb-3">Đăng ký trở thành tác giả 🚀</h1>
        <p className="text-[13px] mb-2">
        Tôi viết vì tôi thích, được tiền lại càng thích
        </p>
        <form className="flex flex-col gap-4">
          <Input type="text" title="Email" />
          <Input type="password" title="Mật khẩu" />
          <div className="flex items-center text-[12px] gap-2">
            <input type="checkbox" className="cursor-pointer" />
            Tôi đồng ý với<Link className="text-[#7367F0]" href="/register">điều khoản sử dụng</Link>
          </div>
          <button className="bg-[#7367F0] py-2 text-[14px] rounded-lg">
            Đăng ký
          </button>
          <div className="text-[12px] flex items-center justify-center">
            <span>
              Đã tài khoản?{" "}
              <Link className="text-[#7367F0]" href="/login">
                Đăng nhập
              </Link>
            </span>
          </div>
